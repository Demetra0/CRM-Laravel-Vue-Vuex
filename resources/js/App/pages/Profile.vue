    ...
    <div class="user-profile">
        <div class="container">
            ...
            <div v-if="error" style="text-align: center">
                ...
                >
                    <span class="message-registered__text">{{ messageError }}</span>
                </b-alert>
            </div>

            <div v-if="!(loading === loadProfile)" style="text-align: center">
                <b-spinner
                    label="Loading..."
                    :variant="'primary'"
                    :key="'primary'"
...
export default {
    ...
    mounted() {
        ...
        this.ajaxOneProfilerFromDB(this.$route.params.id)
